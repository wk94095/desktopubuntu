...
vehicle = connect('127.0.0.1:14581', wait_ready=True, baud=115200) #與飛機連線
...
def message():
    ...
    while True:
        msg = { 'lat' : vehicle.location.global_relative_frame.lat ,
                ...
                'name' : 'leader3'}
        messages = [
        {'topic':"drone/leader3", 'payload': json.dumps(msg)},
...
def control():
    ...
    def on_message(client, userdata, msg):
        ...
        print(data.get('drone3'))
        print(target1)
        while data.get('drone3') == True:
